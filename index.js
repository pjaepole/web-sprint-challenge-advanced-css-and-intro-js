...
function lotsOfArt(array) {
  const paintedhundred =[];
  for(let i =0; i<array.length; i++) if(array[i].paintings > 100){paintedhundred.push(array[i].name)}
  return paintedhundred
